...
declare function autotarget OVERLOAD (who as integer, atk_id as integer, bslot() as BattleSprite, t() as integer, queue as bool=YES, override_blocking as integer=-2, dont_retarget as bool=NO, initial_attack as bool = NO) as bool
declare function autotarget OVERLOAD (who as integer, byref atk as AttackData, bslot() as BattleSprite, t() as integer, queue as bool=YES, override_blocking as integer=-2, dont_retarget as bool=NO, initial_attack as bool = NO) as bool
declare function autotarget OVERLOAD (who as integer, atk_id as integer, bslot() as BattleSprite, queue as bool=YES, override_blocking as integer=-2, dont_retarget as bool=NO, initial_attack as bool = NO) as bool
declare function autotarget OVERLOAD (who as integer, byref atk as AttackData, bslot() as BattleSprite, queue as bool=YES, override_blocking as integer=-2, dont_retarget as bool=NO, initial_attack as bool = NO) as bool
