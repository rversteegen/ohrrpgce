...
DIM SHARED resizable_resolution as bool = NO    'Adjust resolution when the window size changes
DIM SHARED resizable_window as bool = YES
...
DIM SHARED min_window_resolution as XYPair = XY(10, 10)  'Used only if 'resizable_window' true. Excludes zoom factor.
...
FUNCTION gfx_sdl2_set_resizable(enable as bool, min_width as integer, min_height as integer) as bool
  ...
  SDL_SetWindowResizable(mainwindow, resizable_window)
  RETURN resizable_resolution 'resizable
END FUNCTION
