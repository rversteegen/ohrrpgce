...
CONST SL_EDITOR_DRAW_CANVAS            = -600
CONST SL_EDITOR_DRAW_PALETTE           = -601
CONST SL_EDITOR_DRAW_MASTERPAL         = -602
CONST SL_EDITOR_DRAW_FLIP              = -603
CONST SL_EDITOR_DRAW_PREV_PAL          = -604
CONST SL_EDITOR_DRAW_NEXT_PAL          = -605
CONST SL_EDITOR_DRAW_IMPORT            = -612
CONST SL_EDITOR_DRAW_PREVIEW           = -613
CONST SL_EDITOR_DRAW_LESS_AREA         = -614
CONST SL_EDITOR_DRAW_LESS_MIST         = -615
CONST SL_EDITOR_DRAW_MORE_AREA         = -616
CONST SL_EDITOR_DRAW_MORE_MIST         = -617
CONST SL_EDITOR_DRAW_PAL_NUM           = -618
CONST SL_EDITOR_DRAW_UNDO              = -619
CONST SL_EDITOR_DRAW_REDO              = -620
CONST SL_EDITOR_DRAW_EXPORT            = -625
CONST SL_EDITOR_DRAW_TOOL              = -626  'Used by all tools, tool ID in extra0
