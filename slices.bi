...
DECLARE Function FindSliceCollision(parent as Slice Ptr, sl as Slice Ptr, byref num as integer, descend as bool, top_to_bottom as bool) as Slice Ptr
DECLARE Function FindSliceAtPoint(parent as Slice Ptr, x as integer, y as integer, byref num as integer, descend as bool, top_to_bottom as bool) as Slice Ptr
