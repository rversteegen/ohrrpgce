...
'<SLICE LOOKUP NAMES>
  ...
  CASE SL_EDITOR_DRAW_CANVAS: RETURN "editor draw canvas"
  CASE SL_EDITOR_DRAW_PALETTE: RETURN "editor draw palette"
  CASE SL_EDITOR_DRAW_MASTERPAL: RETURN "editor draw masterpal"
  CASE SL_EDITOR_DRAW_FLIP: RETURN "editor draw flip"
  CASE SL_EDITOR_DRAW_PREV_PAL: RETURN "editor draw prev pal"
  CASE SL_EDITOR_DRAW_NEXT_PAL: RETURN "editor draw next pal"
  CASE SL_EDITOR_DRAW_IMPORT: RETURN "editor draw import"
  CASE SL_EDITOR_DRAW_PREVIEW: RETURN "editor draw preview"
  CASE SL_EDITOR_DRAW_LESS_AREA: RETURN "editor draw less area"
  CASE SL_EDITOR_DRAW_LESS_MIST: RETURN "editor draw less mist"
  CASE SL_EDITOR_DRAW_MORE_AREA: RETURN "editor draw more area"
  CASE SL_EDITOR_DRAW_MORE_MIST: RETURN "editor draw more mist"
  CASE SL_EDITOR_DRAW_PAL_NUM: RETURN "editor draw pal num"
  CASE SL_EDITOR_DRAW_UNDO: RETURN "editor draw undo"
  CASE SL_EDITOR_DRAW_REDO: RETURN "editor draw redo"
  CASE SL_EDITOR_DRAW_EXPORT: RETURN "editor draw export"
  CASE SL_EDITOR_DRAW_TOOL: RETURN "editor draw tool"
