...
CONST fixDefaultDissolve = 3     '(Ignored). Initialized genEnemyDissolve to default in GEN
CONST fixDefaultDissolveEnemy = 4'(Ignored). Initialized Enemy dissolves to default in DT1
