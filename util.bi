...
declare function lines_from_file (strarray() as string, filename as string, expect_exists as bool = YES, lazy_close as bool = NO) as bool
...
declare function check_interned_string(s as zstring ptr) as zstring ptr
...
declare function format_duration(total_seconds as double, decimal_places as integer = 1, minutes_always as bool = NO) as string
