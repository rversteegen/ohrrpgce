...
DECLARE SUB anim_waitforone(byval who as integer)
...
DECLARE SUB anim_dissolve(byval who as integer, byref params as AttackDissolveParams)
DECLARE SUB anim_undissolve(byval who as integer, byref params as AttackDissolveParams)
DECLARE SUB anim_pausedissolve(byval who as integer)
