...
DECLARE SUB anim_absmovespeed(byval who as integer, byval tox as integer, byval toy as integer, byval speed as integer)
...
DECLARE SUB anim_relmovespeed(byval who as integer, byval tox as integer, byval toy as integer, byval speed as integer)
